...
from Models.Pretrained_Generator import DeepOracle_With_T5_Small
...
def train():
    ...
    model = DeepOracle_With_T5_Small(config)
    checkpoint = os.path.join(outmodel_dir, 'Decoder_best.ckpt')
