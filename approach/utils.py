...
#with open('/data02/huangzhengfei/graduation_project/Modules/MATL/vocab/ast_vocab.pk', 'rb') as f:
#    vocab = pickle.load(f)
#import dill
#with open('/data02/huangzhengfei/graduation_project/Modules/MATL/vocab/ast_vocab_new.pk', 'wb') as f:
#    dill.dump(vocab, f)
...
def load_vocab_pk(file_name) -> Vocab:
    ...
    path = os.path.join('/root/huangzhenfei/graduation_project/Modules/MATL/vocab/', file_name)
