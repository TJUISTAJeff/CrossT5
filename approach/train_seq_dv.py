...
def train():
    ...
    ori_train = readpickle(os.path.join(PROJECT_ROOT, f'datasets/processtraindata{accelerator.process_index}.pkl'))
    ...
    # ori_dev = readpickle(os.path.join(PROJECT_ROOT, f'datasets/processdevdata.pkl'))
