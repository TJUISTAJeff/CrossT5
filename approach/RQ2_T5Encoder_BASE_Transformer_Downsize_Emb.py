...
from Models.Pretrained_Generator import DeepOracle_With_T5_Base_Downsize
...
config = Configurable('config/t5encoder_base_transformer_downsize_no_emb.ini')
...
def train():
    ...
    if accelerator.is_main_process:
        wandb.init(entity='ista_oracle_team', project="DeepOracle", name='t5_base_transformer_decoder_downsize_emb')
    device = accelerator.device
    print('Start training.')
    model = DeepOracle_With_T5_Base_Downsize(config)
